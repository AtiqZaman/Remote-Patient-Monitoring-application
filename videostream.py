...
your_env_access_key_var = 'aws_access_key_id'
your_env_secret_key_var = 'aws_secret_access_key'
your_stream_name = 'atiqvideostream'
...
class gen_request_parameters:
    def __init__(self):
        self._data = ''
        if True:
            localfile = '/home/atiq/PycharmProjects/RPM/sample_mkv_video.mkv' # upload ok
